<template>
  <transition  name="fade">
    ...
    <div class="list"  ref="slid">
      <ul class="song" v-if="songs" ref="msilder">
    ...
    export default {
      ...
      watch:{
        ...
        methods:{
          ...
          _getDetail(){
            //获取歌曲的详细信息
            this.songArr = getOfflLine().reverse();
            ...
            this.$nextTick(() => {
              if(this.song.length != 0){
                ...
                this.$refs.msilder.style.paddingBottom = 0 ;
              }
            })
...
<style scoped lang="less"  rel="stylesheet/less">
    ...
    .coolFolder {
      ...
      .title{
        ...
        line-height: 40px;
        font-size:20px;
        background-image: url("../common/image/b-yizi.png");
        .back{
          position: absolute;
          left:0;
          top:0;
